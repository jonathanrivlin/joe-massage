...
const NEIGHBORHOODS = {
  ...
  'בירמ': {
    slug: 'בירמ',
    name: 'בירמ',
    title: 'עיסוי שוודי בבירמ ירושלים | ג'ו — 25+ שנות ניסיון | 052-263-5895',
    description: 'עיסוי שוודי הוליסטי בבירמ ירושלים — ג'ו מגיע אליכם הביתה. שחרור שרירים, הפחתת כאבים, שמנים ארומתרפיים. 052-263-5895',
    h1: 'עיסוי שוודי הוליסטי בבירמ',
    intro: 'גרים בבירמ וחיפשתם עיסוי שוודי מקצועי? ג'ו — מעסה שוודי הוליסטי עם 25+ שנות ניסיון — מגיע אליכם לבירמ. טיפול אישי, מקצועי ומותאם לצרכים שלכם.',
    body: 'בירמ (בית הכרם-רמות-מרכז), אזור ירושלים, מקבלת שירות עיסוי שוודי הוליסטי מקצועי מג'ו. הטיפול כולל עיסוי שוודי מלא עם שמנים ארומתרפיים, שחרור שרירים תפוסים ורגיעה עמוקה.\n\nג'ו מגיע עם כל הציוד הנדרש ומתאים את הטיפול לצרכים הייחודיים של כל מטופל.',
