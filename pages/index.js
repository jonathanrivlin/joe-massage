  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "האם ג'ו מגיע לטיפול בבית?", "acceptedAnswer": { "@type": "Answer", "text": "כן — ג'ו מגיע אליכם הביתה בירושלים ופסגת זאב." } }
      ]
    }
  ]
}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 pb-10 border-b border-red-800">
            ...
            <div>
              ...
              <ul className="text-sm text-red-300 leading-7 space-y-2">
                <li>
                  <a href="tel:0522635895" className="inline-flex items-center gap-2 hover:text-white transition-colors">
                    <FontAwesomeIcon icon={faPhone} className="w-3.5 h-3.5" />
                    052-263-5895
                  </a>
                </li>
                <li>
                  <a href={WA_HREF} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 hover:text-white transition-colors">
