...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "מה היא שיטת עיסוי שוודי?", "acceptedAnswer": { "@type": "Answer", "text": "עיסוי שוודי הוא שיטת טיפול המבוססת על לחיצה וחיכוך ממוקדים על שרירים ורקמות. הטיפול מתבצע עם שמנים ארומתרפיים ומותאם אישית לכל מטופל — לשחרור שרירים תפוסים, הפחתת כאבים ורגיעה עמוקה." } },
        ...
        { "@type": "Question", "name": "מה כדאי לדעת לפני הטיפול הראשון?", "acceptedAnswer": { "@type": "Answer", "text": "מומלץ להגיע רעבים למחצה, ללבוש בגדים נוחים, ולהודיע מראש על בעיות בריאות, פציעות או אזורים רגישים. ג'ו יסתגל לפי הצרכים שלכם." } }
      ]
    }
  ]
}
...
const benefits = [
  ...
  { icon: faClock,        title: 'שעות גמישות', desc: 'ראשון–חמישי 8:00–21:00, שישי עד הצהריים.' },
  { icon: faTrophy,       title: '25+ שנות ניסיון', desc: 'מעל רבע מאה ניסיון מקצועי בעיסוי שוודי בירושלים.' },
]

const faqs = [
  { question: 'מה היא שיטת הטיפול?', answer: 'עיסוי שוודי הוא שיטת טיפול המבוססת על לחיצה וחיכוך ממוקדים על שרירים ורקמות. הטיפול מתבצע עם שמנים ארומתרפיים ומותאם אישית לכל מטופל — לשחרור שרירים תפוסים, הפחתת כאבים ורגיעה עמוקה.' },
  ...
  { question: "מה כדאי לדעת לפני הטיפול הראשון?", answer: "מומלץ להגיע רעבים למחצה (לא לאכול ארוחה כבדה שעה לפני), ללבוש בגדים נוחים, ולהודיע מראש על בעיות בריאות, פציעות או אזורים רגישים. ג'ו יסתגל לפי הצרכים שלכם." },
]
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>☯ ג&apos;ו עיסוי שוודי בירושלים</title>
